...
            var scntDiv = $('#p_scents');
        ...
        $('#addScnt').live('click', function() {
                $('<p><input type="text" id="ip_' + i +'" size="20" name="ip[]" /> <button id="remScnt">Remove</button></p>').appendTo(scntDiv);
                $('#count').val(i);
                i++;
...
    </script>
	...
	<body class="bgc">
		<div id="admin">
			<div id="wrap">
				<div id="head">
					<h1><a href="index.html">conjure admin
					<br />
					...
					<ul id="tablist">
						<li>
							<a href="#a"><span>Dashboard Links</span></a>
						</li>
						<li>
							<a href="#b"><span>Image Gallery</span></a>
						</li>
					</ul>
					<div id="tabsPanel">
				...
				<div id="content">
					<div class="styles">
						<div class="heading">
							<h2><a href="/index.php/vm/index">VM List</a> > <a href="">Create</a></h2>
						...
						<div class="inner">
							...
							<ul class="list-styled">
								...
								<?php
								echo form_open('vm/insert');
							?>
								<li>
									<strong>Name</strong>
									<br />
									<input type='input' name='vmname' value='' />
								</li>
								<li>
									<strong>User</strong>
									<br />
								...
								<li>
									<div id="p_scents">
    <p>
    	<label for="ip_1"><strong>IP</strong></label></br><input type="text" name="ip[]" id="ip_1" /><button id="addScnt">Add</button>
    </p>
</div>
								</li>
